...
describe('Explere Page', () => {
  ...
  it('should render filters columns', () => {
    ...
    cy.getFilterFields(sortFields)
    cy.getFilterFields(priceFields)
    cy.getFilterFields(platformFields)
    cy.getFilterFields(genreFields)
  })

  it('should show 15 games and sow more games when show more is clicked', () => {
